...
$options = array(
	'ls_section' => array(
		...
		'type'        => 'title',
		'description' => wp_kses(
			__('To integrate with Write with AI services, you need to obtain an API key from your chosen provider. Visit the respective service provider’s website to generate an API key.', 'classified-listing'),
			array(
				'a' => array(
					'href' => array(),
					'target' => array(),
	...
	'gpt_api_key'          => [
		...
		'type'        => 'password',
		'description' => wp_kses(
			__('To integrate with ChatGPT, you need to obtain an API key from OpenAI. Visit <a href="https://platform.openai.com/account/api-keys" target="_blank">OpenAI API Keys</a> to generate one.', 'classified-listing'),
			array(
				'a' => array(
					'href'   => array(),
					'target' => array(),
	...
	'gpt_max_token' => [
		...
		'type'        => 'number',
		'description' => esc_html__('Set the maximum character limit for the prompt input. This controls how many characters users can enter, ensuring input stays concise and manageable. Higher limits may affect performance and response quality.', 'classified-listing'),
		'default'     => '200',
		'required'    => true,
	...
	'gemini_api_key'       => [
		...
		'type'        => 'password',
		'description' => wp_kses(
			__('To integrate with Google Gemini, you need to obtain an API key from Google Cloud. Visit <a href="https://makersuite.google.com/app/apikey" target="_blank">Google AI Studio API Keys</a> to generate one.', 'classified-listing'),
			array(
				'a' => array(
					'href'   => array(),
					'target' => array(),
	...
	'deepseek_api_key'       => [
		...
		'type'        => 'password',
		'description' => wp_kses(
			__('To integrate with DeepSeek, you need to obtain an API key from DeepSeek. Visit <a href="https://www.deepseek.com/api-keys" target="_blank">DeepSeek API Keys</a> to generate one.', 'classified-listing'),
			array(
				'a' => array(
					'href'   => array(),
					'target' => array(),
