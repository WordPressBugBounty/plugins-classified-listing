...
* **Local Business Directory:** The best alternative for a "Yelp" or "Yellow Pages" style site, complete with maps, business hours, and reviews.
...
* Fixed: Checkbox options in the form builder Settings tab crashing the editor and not saving.
* Fixed: Form builder booking field crashing the listing form when no booking types are enabled.
* Fixed: Compatibility issue with the Job Manager addon.
* Improved: Ajax filter reset icon is now a plain colored icon instead of a filled circle.
* Improved: Ajax filter More/Less now uses a chevron instead of a plus and minus.
* Improved: Form builder containers and layout columns now show their name, not just the width.
* Improved: Width badge has a resize icon and a tooltip explaining Auto and the device.
* Added: "Visit the Page" link under every page dropdown in Page Setup settings.
* Added: Redesigned Add New Field popup with search and field type descriptions.
* Added: Form list shows badges for add-on form options, such as Job forms.
* Added: Category filter option to show only sub-categories of the included categories.
* Added: Form builder support for the Job Manager "Application Form" preset field.
* Added: Ajax filter Categories item can include or exclude specific categories.
* Added: Ajax filter option to show sub-categories expanded by default.
* Added: Form Builder add-ons can add their own field group to the Available Fields panel.
...
* Fixed: AJAX filter custom field checkbox issue
* Fixed: Password eye icon click issue on mobile
* Fixed: Country code dropdown issue
...
* Fixed: Price step issue at admin end to set decimal value

= 5.3.5 ( Jan 29, 2026 ) =
* Fixed: Listing archive page site title issue
* Fixed: Sanitization issue 
* Fixed: Tax amount calculation issue
* Fixed: Map field latitude and longitude save issue
* Fixed: Grid column set issue
* Added: User profile data privacy option

= 5.3.4 ( Jan 08, 2026 ) =
* Fixed: Radio button style issue
* Fixed: Map view center position issue
* Fixed: Vimeo thumbnail issue
* Fixed: Repeater data export/import issue
* Fixed: AJAX filter listing not found message display issue
* Added: YouTube shorts video support
* Added: Block theme header and footer support
* Added: Apple image extension support

= 5.3.3 ( Dec 22, 2025 ) =
* Fixed: WCAG/Accessibility issues
* Fixed: AI Image Enhancement style issue
* Fixed: Builder section dynamic width issue
* Added: OTP login compatibility
* Added: An image upload option for location

= 5.3.2 ( Nov 28, 2025 ) =
* Fixed: Pricing & payment admin menu access issue when disabled payment
* Added: Account type field at registration form

= 5.3.1 ( Nov 25, 2025 ) =
* Fixed: Settings responsive issue
* Fixed: Multiple email to owner while publish listing from admin end
* Added: AI semantic search compatibility for gutenberg block

= 5.3.0 ( Nov 20, 2025 ) =
* Fixed: Add/Remove favourite UX issue
* Fixed: Taxonomy-ordering issue
