import { r as reactExports, g as _slicedToArray, _ as _typeof, e as _extends, h as _defineProperty, f as React, c as _objectWithoutProperties, b as _toConsumableArray, a as _objectSpread2, i as reactDomExports, j as _inherits, k as _createSuper, l as _classCallCheck, n as _createClass } from "./objectWithoutProperties-Ds_Zj76B.js";
import { Y as pickAttrs, c as classNames, X as KeyCode, bP as CSSMotionList, v as useEvent, i as genStyleHooks, m as merge, au as Keyframe, r as resetComponent, bS as CONTAINER_MAX_OFFSET, C as ConfigContext, x as useCSSVarCls, av as RefIcon$2, a9 as RefIcon$3, aJ as RefIcon$4, aI as RefIcon$5, bT as RefIcon$6, K as devUseWarning, bR as RefIcon$7, L as useToken, u as useForceUpdate, ad as useLayoutEffect, w as wrapperRaf, bf as composeRef, g as getNodeRef, af as supportRef, a$ as Trigger, ag as useMemo, ae as isEqual, aj as isVisible, M as useMergedState, Q as warningOnce, b as useComposeRef, o as omit, b1 as ForwardOverflow, t as toArray, at as CSSMotion, W as Icon$1, b0 as useLayoutUpdateEffect, ai as RefResizeObserver, bm as isMobile, a_ as getTransitionName, k as initSlideMotion, e as unit, h as textEllipsis, f as genFocusOutline, G as genFocusStyle, aO as RefIcon$8, a5 as useSize, n as clearFix, bs as useVariant, bU as Skeleton, bV as useRowStyle, bW as unstableSetRender, aD as ConfigProvider, bX as globalConfig, a4 as useComponentConfig, bY as RefIcon$9, aQ as Progress, T as Tooltip } from "./index-C06Th-Ga.js";
...
const InternalTabs = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  if (type === "editable-card") {
    editable = {
      ...
      addIcon: (addIcon !== null && addIcon !== void 0 ? addIcon : tabs === null || tabs === void 0 ? void 0 : tabs.addIcon) || /* @__PURE__ */ reactExports.createElement(RefIcon$8, null),
  ...
  return wrapCSSVar(/* @__PURE__ */ reactExports.createElement(Tabs$1, Object.assign({
    ...
    editable,
    more: Object.assign({
      icon: (_l = (_k = (_j = (_h = tabs === null || tabs === void 0 ? void 0 : tabs.more) === null || _h === void 0 ? void 0 : _h.icon) !== null && _j !== void 0 ? _j : tabs === null || tabs === void 0 ? void 0 : tabs.moreIcon) !== null && _k !== void 0 ? _k : moreIcon) !== null && _l !== void 0 ? _l : /* @__PURE__ */ reactExports.createElement(RefIcon$1, null),
...
const Steps = (props) => {
  ...
  const realDirectionValue = reactExports.useMemo(() => responsive && xs ? "vertical" : direction, [responsive, xs, direction]);
  ...
  const icons = {
    finish: /* @__PURE__ */ reactExports.createElement(RefIcon$9, {
      className: `${prefixCls}-finish-icon`
    }),
    error: /* @__PURE__ */ reactExports.createElement(RefIcon$7, {
