import { r as reactExports, g as _slicedToArray, f as React, h as _defineProperty, a as _objectSpread2, e as _extends$2, b as _toConsumableArray, _ as _typeof, c as _objectWithoutProperties, n as _createClass, l as _classCallCheck, i as reactDomExports, j as _inherits, k as _createSuper, m as _assertThisInitialized$1, o as jsxRuntimeExports } from "./objectWithoutProperties-CEUlrGvr.js";
import { c as classNames, q as useEvent$1, aQ as calculateColor, aR as calcOffset, L as useMergedState, aS as generateColor, aT as Color, aU as ColorPickerPrefixCls, aV as ColorBlock, aW as defaultColor, h as genStyleHooks, m as merge$1, k as initZoomMotion, D as getArrowStyle, r as resetComponent, aX as PresetColors, I as getArrowToken, H as getArrowOffsetToken, C as ConfigContext, aY as Popup$1, a3 as useComponentConfig, T as Tooltip, aZ as getTransitionName, a as cloneElement, W as KeyCode, V as Icon$1, a_ as Trigger, w as wrapperRaf, P as warningOnce, a$ as useLayoutUpdateEffect, ac as useLayoutEffect, ai as isVisible, ah as RefResizeObserver, X as pickAttrs, o as omit, b0 as ForwardOverflow, b1 as FormItemInputContext, a7 as Select, b2 as Group, b3 as Button, b4 as genOverflowStyle, b5 as getMultipleSelectorUnit, d as unit, F as FastColor, Z as initComponentToken, b6 as genOutlinedStyle, b7 as genUnderlinedStyle, b8 as genFilledStyle, b9 as genBorderlessStyle, Y as initInputToken, ba as genCompactItemStyle, j as initSlideMotion, E as initMoveMotion, z as slideUpOut, y as slideDownOut, B as slideUpIn, A as slideDownIn, f as textEllipsis, bb as genRoundedArrow, bc as genPlaceholderStyle, a5 as useLocale$1, bd as locale, e as genFocusOutline, be as DisabledContext, bf as composeRef, v as useCSSVarCls, bg as TARGET_CLS, bh as useBubbleLock, bi as Wave, bj as Checkbox$2, at as CSSMotion, G as genFocusStyle, bk as useId, a4 as useSize, bl as generateColor$1, bm as isMobile, bn as BaseInput, bo as triggerFocus, _ as genBasicInputStyle, bp as genInputGroupStyle, bq as genOutlinedGroupStyle, br as genFilledGroupStyle, n as resetIcon, Q as useCompactItemContext, bs as useVariant, bt as getStatusClassNames, b as ContextIsolator, aq as RefIcon$g, bu as getMergedStatus, aC as ConfigProvider, bv as getColorAlpha, bw as toHexFormat, aw as Input$1, bx as getRoundNumber, ad as isEqual, by as getGradientPercentColor, bz as AggregationColor, bA as genAlphaColor, bB as ColorPresets, aF as Divider, O as genPurePanel, bC as useIcons$1, U as Button$1, p as useZIndex, bD as isPresetSize, au as Keyframe, a2 as genSubStyleComponent, bE as genPresetColor, bF as isPresetColor, bG as isPresetStatusColor, bH as useClosable, bI as replaceElement, bJ as pickClosable, bK as _asyncToGenerator, bL as _regeneratorRuntime, l as clearFix, bM as initFadeMotion, bN as blue, i as genCollapseMotion, bO as RefIcon$h, aP as Progress$1, as as useForceUpdate, x as initCollapseMotion, bP as CSSMotionList, av as RefIcon$i, a9 as localeValues } from "./index-7PgBpbYv.js";
import { g as getDefaultExportFromCjs } from "./_commonjsHelpers-CCIqAdii.js";
import { e as createCache, g as getRegisteredStyles, s as serializeStyles, i as insertStyles, h as hoistNonReactStatics$1 } from "./hoist-non-react-statics.cjs-B-G8xHv9.js";
...
var RefIcon$e = /* @__PURE__ */ reactExports.forwardRef(UpOutlined);
...
const InputNumber = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  let upIcon = /* @__PURE__ */ reactExports.createElement(RefIcon$e, {
...
const generateRangePicker = (generateConfig2) => {
  const RangePicker2 = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
    ...
    const {
      ...
      styles,
      classNames: classNames$1
    } = props, restProps = __rest$7(props, ["prefixCls", "getPopupContainer", "components", "className", "style", "placement", "size", "disabled", "bordered", "placeholder", "popupStyle", "popupClassName", "dropdownClassName", "status", "rootClassName", "variant", "picker", "styles", "classNames"]);
    ...
    const suffixNode = /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, picker === TIME ? /* @__PURE__ */ reactExports.createElement(RefIcon$c, null) : /* @__PURE__ */ reactExports.createElement(RefIcon$d, null), hasFeedback && feedbackIcon);
  ...
  const getPicker = (picker, displayName) => {
    ...
    const Picker3 = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
      ...
      const {
        ...
        styles,
        classNames: classNames$1
      } = props, restProps = __rest$6(props, ["prefixCls", "getPopupContainer", "components", "style", "className", "rootClassName", "size", "bordered", "placement", "placeholder", "popupStyle", "popupClassName", "dropdownClassName", "disabled", "status", "variant", "onCalendarChange", "styles", "classNames"]);
      const {
        getPrefixCls,
        direction,
        getPopupContainer,
      ...
      const suffixNode = /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, mergedPicker === "time" ? /* @__PURE__ */ reactExports.createElement(RefIcon$c, null) : /* @__PURE__ */ reactExports.createElement(RefIcon$d, null), hasFeedback && feedbackIcon);
...
var _excluded$1 = ["component", "prefixCls", "className", "classNames", "disabled", "id", "name", "style", "styles", "multiple", "accept", "capture", "children", "directory", "openFileDialogOnClick", "onMouseEnter", "onMouseLeave", "hasControlInside"];
...
var RefIcon$9 = /* @__PURE__ */ reactExports.forwardRef(FileTwoTone);
...
var RefIcon$8 = /* @__PURE__ */ reactExports.forwardRef(PaperClipOutlined);
...
var RefIcon$7 = /* @__PURE__ */ reactExports.forwardRef(PictureTwoTone);
...
var RefIcon$6 = /* @__PURE__ */ reactExports.forwardRef(DownloadOutlined);
const ListItem = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  const removeIcon = (typeof showRemoveIcon === "function" ? showRemoveIcon(file) : showRemoveIcon) ? actionIconRender(
    (typeof customRemoveIcon === "function" ? customRemoveIcon(file) : customRemoveIcon) || /* @__PURE__ */ reactExports.createElement(RefIcon$a, null),
    () => onClose(file),
    prefixCls,
    locale2.removeFile,
  ...
  }, typeof customPreviewIcon === "function" ? customPreviewIcon(file) : customPreviewIcon || /* @__PURE__ */ reactExports.createElement(RefIcon$h, null)) : null;
...
const InternalUploadList = (props, ref) => {
  ...
  const internalIconRender = (file) => {
    ...
    if (listType.startsWith("picture")) {
      const loadingIcon = listType === "picture" ? /* @__PURE__ */ reactExports.createElement(RefIcon$i, null) : locale2.uploading;
      const fileIcon = (isImgUrl === null || isImgUrl === void 0 ? void 0 : isImgUrl(file)) ? /* @__PURE__ */ reactExports.createElement(RefIcon$7, null) : /* @__PURE__ */ reactExports.createElement(RefIcon$9, null);
      return isLoading ? loadingIcon : fileIcon;
    }
    return isLoading ? /* @__PURE__ */ reactExports.createElement(RefIcon$i, null) : /* @__PURE__ */ reactExports.createElement(RefIcon$8, null);
  };
...
var RefIcon$5 = /* @__PURE__ */ reactExports.forwardRef(CameraOutlined);
...
const collectSlUsedFields = (singleLayout) => {
  ...
  for (const sec of singleLayout?.sections ?? []) {
...
const generateFormStructure = (fields, translatedTitle, availableFields) => {
  ...
  return {
    ...
    sections: Object.entries(sectionFieldsMap).map(([section, fields2], index2) => ({
      ...
      column: "",
      logics: "",
      columns: [{ width: 100, fields: fields2.length > 0 ? fields2 : [] }],
      element: "section",
      css_class: ""
    })),
    settings: {
...
export {
  ...
  isEmpty as E,
  Flex as F,
  verticalListSortingStrategy as G,
  HelpMessage as H,
  useDroppable as I,
  useDraggable as J,
  isObject as K,
  ...
  closestCenter as V,
  useSensors as W,
  sortableKeyboardCoordinates as X,
  KeyboardSensor as Y,
  DragOverlay as Z,
  arrayMove as _,
  Popover as a,
  collectSlUsedFields as a0,
  fetchAIKeyword as a1,
  generateFormStructure as a2,
  submitFormData as a3,
  fetchAIFormField as a4,
  isValidateField as a5,
  fetchAIChatWithCustomer as a6,
  getPlainTextLength as a7,
  getFileNameFromUrl as a8,
  convertBytes as a9,
  weekday as aa,
  localeData as ab,
  weekOfYear as ac,
  RefIcon$c as ad,
  stripPhoneDialCode as ae,
  isValidateCondition as af,
  isValidateRepeaterFields as ag,
  getStyle as b,
  CrossIcon as c,
  RefIcon$4 as d,
  TypedInputNumber as e,
  PointerSensor as f,
  getRenderPropValue as g,
  SortableContext as h,
  horizontalListSortingStrategy as i,
  RefIcon$3 as j,
  useSortable as k,
  CSS as l,
  css as m,
  ...
  purify as p,
  RefIcon as q,
  RecaptchaWrapper as r,
  ColorPicker as s,
  convertDateTimeFormatPhpToJS as t,
  useSensor as u,
  TimePicker as v,
  DatePicker as w,
  Calendar as x,
