...
class LocalizedString {
	...
	public static function public() {
		$strings = [
			...
			'invalid_url'        => __( 'Invalid URL', 'classified-listing' ),
			/* translators: %s: social platform name, e.g. Facebook */
			'invalid_social_url' => __( 'Please enter a valid %s URL', 'classified-listing' ),
	...
	public static function admin() {
		$adminStrings = [
			...
			'fields'                         => __( 'Form Builder', 'classified-listing' ),
			...
			'slug_builder'                   => __( 'Slug Builder', 'classified-listing' ),
			'path_segments'                  => __( 'URL Path Segments', 'classified-listing' ),
			'slug_fields'                    => __( 'Listing Slug Fields', 'classified-listing' ),
			'prefix'                         => __( 'Prefix', 'classified-listing' ),
			'postfix'                        => __( 'Postfix', 'classified-listing' ),
			'separator'                      => __( 'Separator', 'classified-listing' ),
			'item_pick_all'                  => __( 'All items', 'classified-listing' ),
			'item_pick_first'                => __( 'First item', 'classified-listing' ),
			'item_pick_last'                 => __( 'Last item', 'classified-listing' ),
			'slug_builder_demo_url'          => __( 'Demo URL', 'classified-listing' ),
			'drop_fields_here'               => __( 'Drag fields here', 'classified-listing' ),
			'slug_builder_active'            => __( 'Enable Slug Builder', 'classified-listing' ),
			'global_separator'               => __( 'Global Separator', 'classified-listing' ),
			'listing_id'                     => __( 'Listing ID', 'classified-listing' ),
			'custom_text'                    => __( 'Custom Text', 'classified-listing' ),
			'common_fields'                  => __( 'Common Fields', 'classified-listing' ),
			'import_incompatible'            => FBHelper::importIncompatibleMessage(),
		];
