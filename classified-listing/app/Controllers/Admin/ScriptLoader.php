			...
			apply_filters(
				...
				[
					'messages'      => [
						...
						'password'        => sprintf( esc_html__( 'Password must be at least %d characters with uppercase, lowercase, digit and special character.', 'classified-listing' ),
					...
					'pwsL10n'       => [
						...
						'hint_missing'   => esc_html__( 'Missing:', 'classified-listing' ),
						/* translators: Password length */
						'hint_min_length' => sprintf( esc_html__( '%d+ characters', 'classified-listing' ), Functions::password_min_length() ),
						'hint_uppercase' => esc_html__( 'uppercase', 'classified-listing' ),
						'hint_lowercase' => esc_html__( 'lowercase', 'classified-listing' ),
						'hint_digit'     => esc_html__( 'digit', 'classified-listing' ),
						'hint_special'   => esc_html__( 'special character', 'classified-listing' ),
					],
					'scroll_top'    => 200,
