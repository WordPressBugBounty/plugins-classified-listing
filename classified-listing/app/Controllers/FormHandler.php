...
class FormHandler {
	...
	public static function process_login() {
		...
		$nonce_value = Functions::get_var( $_REQUEST['rtcl-login-nonce'] ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	public static function process_registration() {
		...
		if ( ! empty( $_POST['rtcl-register'] ) && wp_verify_nonce( $_POST['rtcl-register-nonce'] ?? null, 'rtcl-register' ) ) {
