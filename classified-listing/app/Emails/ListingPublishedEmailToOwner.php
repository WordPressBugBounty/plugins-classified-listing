...
use Rtcl\Interfaces\RtclEmailInterface;
use Rtcl\Models\Listing;
use Rtcl\Models\RtclEmail;

class ListingPublishedEmailToOwner extends RtclEmail
{
    /**
     * Constructor.
     */
    public function __construct() {
        ...
        $this->db = true;
        $this->id = 'listing_published';
        $this->template_html = 'emails/listing-published-email-to-owner';
